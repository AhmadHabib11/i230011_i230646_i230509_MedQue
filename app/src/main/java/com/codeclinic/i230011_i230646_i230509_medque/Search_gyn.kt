...
class Search_gyn : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_search_gyn)
        ...
        val navcalender = findViewById<ImageView>(R.id.calendarIcon)
        ...
        val carbtn= findViewById<TextView>(R.id.btnCardiologist)
