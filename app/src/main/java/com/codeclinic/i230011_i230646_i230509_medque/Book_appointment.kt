...
class Book_appointment : AppCompatActivity() {
    ...
    private var patientId: Int = 0 // This should come from session/SharedPreferences
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TODO: Get patient ID from SharedPreferences/session
        // For now using a placeholder - you should get this from login session
        patientId = 1 // Replace with actual logged-in user ID
